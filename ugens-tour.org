...
#+END_SRC
::
** section:: Periodic Sources: Oscillators.                         :sources:
...
definitionlist::
**** ::Classes/LFPar::, link::Classes/LFCub::, link::Classes/LFTri::, link::Classes/LFSaw::, link::Classes/Impulse:: :args:
...
**** ::Classes/LFPulse::, link::Classes/VarSaw::                       :args:
...
definitionlist::
**** ::Classes/SinOsc::, link::Classes/FSinOsc::                       :args:
|| arguments: code::frequency, phase, mul, add::
code::
#+BEGIN_SRC sclang
...
**** ::Classes/Klang:: - sine oscillator bank                          :args:
...
**** ::Classes/COsc:: - two oscillators, detuned                       :args:
...
**** ::Classes/VOsc:: - multiple wave table crossfade oscillators      :args:
|| arguments: code:: buffer number, frequency, phase, mul, add ::
code::
#+BEGIN_SRC sclang
(
...
**** ::Classes/VOsc3:: - three VOscs summed.                           :args:
...
::
::
** section:: Aperiodic Sources: Noise.                              :sources:
*** subsection:: LF "Low Frequency" Noise Generators.

definitionlist::
**** ::Classes/LFNoise0::, link::Classes/LFNoise1::, link::Classes/LFNoise2::, link::Classes/LFClipNoise:: :args:
|| arguments: code:: frequency, mul, add ::
code::
#+BEGIN_SRC sclang
...
definitionlist::
**** ::Classes/ClipNoise::, link::Classes/WhiteNoise::, link::Classes/PinkNoise::, link::Classes/BrownNoise::, link::Classes/GrayNoise:: :args:
...
definitionlist::
**** ::Classes/Dust::, link::Classes/Dust2::                           :args:
...
definitionlist::
**** ::Classes/LPF::, link::Classes/HPF:: - 12 dB / octave :args:in:freq:mul:add:
...
definitionlist::
**** ::Classes/BPF::, link::Classes/BRF:: - 12 dB / octave :args:in:freq:rq:mul:add:
...
definitionlist::
**** ::Classes/RLPF::, link::Classes/RHPF:: - 12 dB / octave :args:in:freq:rq:mul:add:
|| arguments: code:: in, freq, rq, mul, add ::
code::
#+END_SRC
...
**** ::Classes/Resonz:: - resonant band pass filter with uniform amplitude :args:in:freq:rq:mul:add:
|| arguments: code:: in, freq, rq, mul, add ::
code::
#+BEGIN_SRC sclang
// modulate frequency
...
**** ::Classes/Ringz:: - ringing filter.      :args:in:freq:ringtime:mul:add:
...
definitionlist::
**** ::Classes/Median::, link::Classes/Slew::              :in:up:dn:mul:add:
||
code::
#+BEGIN_SRC sclang
...
**** ::Classes/Klank:: - resonant filter bank                          :args:
...
definitionlist::
**** ::Classes/Pan2:: - equal power stereo pan a mono source           :args:
...
**** ::Classes/LinPan2:: - linear pan a mono source (not equal power)  :args:
|| arguments: code:: in, pan position, level ::
...
**** ::Classes/Balance2:: - balance a stereo source                    :args:
...
**** ::Classes/PanAz:: - azimuth panner to any number of channels      :args:
...
**** ::Classes/XFade2:: - equal power cross fade between two inputs    :args:
...
::
::
** section:: Delays and Buffer UGens                         :delays:buffers:
...
**** ::Classes/CombN::, link::Classes/CombL::, link::Classes/CombC:: - feedback delays :args:
...
**** ::Classes/AllpassN::, link::Classes/AllpassL::, link::Classes/AllpassC:: - allpass delay :args:
|| arguments: code:: in, maximum delay time, current delay time, echo decay time, mul, add ::
code::
#+BEGIN_SRC sclang
(
...
**** ::Classes/PlayBuf:: - buffer playback                             :args:
...
::
::
** section:: Granular Synthesis.                                   :granular:

definitionlist::
**** ::Classes/TGrains:: - granulation of a buffer                     :args:
...
**** ::Classes/GrainSin:: - sine grain                                 :args:
...
definitionlist::
**** ::Classes/Decay:: - triggered exponential decay                   :args:
...
**** ::Classes/Decay2:: - triggered exponential attack and exponential decay :args:
...
definitionlist::
**** ::Classes/Trig::, link::Classes/Trig1:: - timed duration gate     :args:
|| arguments: code:: trigger, duration ::
code::
#+BEGIN_SRC sclang
...
**** ::Classes/TDelay:: - delays a trigger. only delays one pending trigger at a time. :args:
...
**** ::Classes/Latch:: - sample and hold                               :args:
...
**** ::Classes/Gate:: - pass or hold                                   :args:
|| arguments: code:: in, trigger ::
code::
#+BEGIN_SRC sclang
...
**** ::Classes/PulseCount:: - count triggers                           :args:
