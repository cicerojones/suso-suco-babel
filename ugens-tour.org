...
definitionlist::
**** ::Classes/LPF::, link::Classes/HPF:: - 12 dB / octave             :args:
...
definitionlist::
**** ::Classes/BPF::, link::Classes/BRF:: - 12 dB / octave             :args:
...
definitionlist::
**** ::Classes/RLPF::, link::Classes/RHPF:: - 12 dB / octave           :args:
|| arguments: code:: in, freq, rq, mul, add ::
code::
#+END_SRC
...
**** ::Classes/Resonz:: - resonant band pass filter with uniform amplitude :args:
|| arguments: code:: in, freq, rq, mul, add ::
code::
#+BEGIN_SRC sclang
// modulate frequency
...
**** ::Classes/Ringz:: - ringing filter.                               :args:
